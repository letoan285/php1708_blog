...
<div class="col-md-8">
	<form action="{{ route('posts.update', $post->id) }}" method="post" enctype="multipart/form-data" id="posts-form">
	{{csrf_field()}}
	<div class="form-group">
		<label for="title">Tên bài viết</label>
		<input type="text" onkeyup="generateSlug();" name="title" class="form-control" id="title" value="{{$post->title}}">
	...
	<img width="200" src="{{asset($post->featured)}}" alt="">
	<div class="form-group">
	...
	<div class="form-group">
		...
		<textarea name="content" id="" cols="30" rows="6" class="form-control">{{$post->content}}</textarea>
